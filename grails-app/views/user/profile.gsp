...
<div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center h-100"><!-- align-items-center -->
        <div class="col-md-4 col-lg-4 col-xl-4">
            ...
            <div class="card mt-5 mb-5 p-1 bg-light" style="border-radius: 15px;">
                <h5 class="card-title m-2">Topics</h5>
                <g:if test="${session.user && (session.user?.isAdmin || session.user?.username == targetUser?.username)}">
                ...
                <g:else>
                    <g:each in="${userTopicsList?.findAll { it.VISIBILITY == enums.VisibilityEnum.PUBLIC }}"
                        ...
                        <div class="card-body p-2 ">
                            <div class="row">
                                <div class="col">
                                    <a href="/topic/showTopic?id=${topicObj.id}">${topicObj?.name}</a>
                                </div>
            ...
            <div class="card mb-5 p-1 bg-light" style="border-radius: 15px;">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <g:if test="${session.user}">
                                                    ...
                                                    %{--                                        <span class="d-none" id="topicId_${topicObj.id}">${topicObj.id}</span>--}%
                                                    %{--                                        <span class="d-none" id="username_${topicObj.id}">${session.user.username}</span>--}%
                                                        <button id="subscribeBtn_${topicObj?.id}"
        ...
        <div class="col-md-7 col-lg-7 col-xl-7 ml-5">
            <div class="card mt-5 p-1 mb-5 bg-light" style="border-radius: 15px;">
                                ...
                                <div class="row d-flex">
                                    ...
                                    <div class="col d-flex">
                                        <g:if test="${resourceObj instanceof linksharing.LinkResource}">
                                            <a class="ml-auto" href="${resourceObj?.url}"
                        ...
                        <g:each in="${targetUser.resource.findAll { it.topic.VISIBILITY == VisibilityEnum.PUBLIC }}"
                            ...
                            <div class="card-body p-2 overflow-auto">
                                ...
                                <div class="row d-flex">
                                    ...
                                    <div class="col d-flex">
                                        <g:if test="${resourceObj instanceof linksharing.LinkResource}">
                                            <a class="ml-auto" href="https://${resourceObj?.url}"
                                               target="_blank">View full site</a>
                                        </g:if>
                                        <g:else>
                                            <g:link class="ml-auto mr-2 btn btn-link p-0" controller="resource"
                                ...
                                <g:if test="${resourceObj.topic.VISIBILITY == enums.VisibilityEnum.PRIVATE && resourceObj.topic.subscription.find { it.user.username == session.user.username }}">
                                    <div class="card-body p-2 overflow-auto">
                                        ...
                                        <div class="row d-flex">
                                            <div class="col col-auto mr-auto">
                                                <a class="mr-2" href="https://facebook.com">
                                                    <img src="${assetPath(src: 'icons/facebook-logo.png')}"
                                                         height="20px"
                                                         width="20px" alt="facebook">
                                                </a>
                                                <a class="mr-2" href="https://twitter.com">
                                            ...
                                            <div class="col d-flex">
                                                ...
                                                <g:else>
                                                    <g:link class="ml-auto mr-2 btn btn-link p-0" controller="resource"
                                                            ...
                                                            params='[resourceId: resourceObj?.id]'>Download</g:link></g:else>
                                                <a class="ml-4"
                                                   href="/resource/viewPost?id=${resourceObj.id}">View post</a>
                                            </div>
                                        </div>
                                    </div>
                                </g:if>
