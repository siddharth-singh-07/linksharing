        ...
        <g:form controller="topic" action="createTopic" method="POST">
            <div class="modal-body">
                <div class="form-outline mb-3">
                    ...
                    <g:field type="text" id="modalCreateTopicNameInput" name="modalCreateTopicNameInput" class="form-control form-control-md" />
                </div>
                <div class="form-outline mb-3">
                    <div><label class="form-label" for="modalCreateTopicVisibilitySelect">Visibility</label>
                    </div>
                    <g:select id="modalCreateTopicVisibilitySelect" name="modalCreateTopicVisibilitySelect" from="${VisibilityEnum.values()}" optionKey="key" class="form-select form-select-lg mb-3 form-control"/>
                </div>
            </div>
            ...
            <g:form controller="resource" action="createLinkResource" method="POST">
                <div class="modal-body">
                    <div class="form-outline mb-3">
                        ...
                        <g:field type="text" id="modalShareLinkLinkInput" name="modalShareLinkLinkInput" class="form-control form-control-md" />
                    </div>
                    <div class="form-outline mb-3">
                        <label class="form-label" for="modalShareLinkDescriptionInput">Description</label>
                        <g:textArea type="" id="modalShareLinkDescriptionInput" name="modalShareLinkDescriptionInput" class="form-control form-control-md"></g:textArea>
                    </div>
                    <div class="form-outline mb-3">
        ...
        <div class="modal-body">
            <g:uploadForm controller="resource" action="createDocumentResource" method="POST">
                <div class="form-outline mb-3">
                    ...
                    <g:field type="file" id="modalShareDocFileInput" name="modalShareDocFileInput" class="form-control" />
                </div>
                <div class="form-outline mb-3">
                    <label class="form-label" for="modalShareDocDescriptionInput">Description</label>
                    <textarea id="modalShareDocDescriptionInput" name="modalShareDocDescriptionInput" class="form-control form-control-md"></textarea>
                </div>
                <div class="form-outline mb-3">
